...
**YOU ARE IN: `soluva/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/soluva/` (rig root) or other directories
...
**Your mail address:** `soluva/polecats/obsidian`
**Your rig:** soluva
**Your Witness:** `soluva/witness`
...
| Ask Witness for help | `gt mail send soluva/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`soluva/witness`) when:
...
```bash
gt mail send soluva/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
